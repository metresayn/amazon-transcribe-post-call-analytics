...
async function createRecord(record) {
    ...
    if (parsed.ConversationAnalytics.Summary !== undefined) {
        if (typeof parsed.ConversationAnalytics.Summary === 'string' || parsed.ConversationAnalytics.Summary instanceof String)
        {
            ...
            // update the summary field with TCA summary if available
            if (parsed.ConversationAnalytics?.ContactSummary?.AutoGenerated?.OverallSummary?.Content) {
                dataJson['summary_summary'] = parsed.ConversationAnalytics?.ContactSummary?.AutoGenerated?.OverallSummary?.Content;
            }
        }
    }
